...
chars_no_spaces = sum(1 for c in text if c != ' ')
chars_no_whitespace = sum(1 for c in text if not c.isspace())
lines = text.count("\n") + 1

print("Total characters (including spaces and newlines):", total_chars)
print("Characters excluding spaces (still counting newlines):", chars_no_spaces)
print("Characters excluding all whitespace (no spaces, tabs, or newlines):", chars_no_whitespace)
